...
public class AuthenticationControllerAdvice extends ResponseEntityExceptionHandler {
	...
	@NotNull
	private String resolveLocal(com.microservice.auth.data.Locale locale, String message) {
		return messageSource.getMessage(message, null,
				locale.equals(com.microservice.auth.data.Locale.EN) ? Locale.ENGLISH : new Locale("ru"));
	}
}